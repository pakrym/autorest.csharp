...
{
    internal class CreateSnapshotHeaders
    {
        private readonly Azure.Response _response;
        public CreateSnapshotHeaders(Azure.Response response)
        {
            _response = response;
        }
        public string? XMsSnapshot => _response.Headers.TryGetValue("x-ms-snapshot", out string? value) ? value : null;
